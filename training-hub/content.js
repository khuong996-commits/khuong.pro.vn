...
'page-thi-truong': `
        ...
        <div class="card-grid" style="grid-template-columns: 1fr; max-width: 1000px; margin: 0 auto; gap: 28px;">
            ...
            <!-- Phường Tùng Thiện - Sơn Tây -->
            <div class="strategy-card vip">
                <div class="card-badge">🏔️ Thị trường 2</div>
                <h3 style="margin-bottom: 12px;">Phường Tùng Thiện – Sơn Tây</h3>
                <p style="color: var(--text-secondary); margin-bottom: 15px;">Đất ở đô thị Hà Nội giá nền thấp, đón sóng hạ tầng Vành đai 5 – QL32 – Metro, nhu cầu thực từ gần 20.000 sinh viên và cư dân khu vực. Phát triển mạnh về bất động sản sinh thái, nghỉ dưỡng ngoại ô Hà Nội.</p>

                <!-- Tài liệu tư vấn -->
                <div style="border-top: 1px solid rgba(0,0,0,0.08); padding-top: 24px; margin-bottom: 10px;">
                    <h4 style="font-size: 1.1rem; font-weight: 800; color: var(--text-primary); margin-bottom: 20px; display: flex; align-items: center; gap: 8px;">
                        <i class="fa-solid fa-file-image" style="color: var(--accent-orange, #f97316);"></i> Tài liệu tư vấn Xuân Khanh
                    </h4>
                ...
                <!-- Thông tin Sơn Tây -->
                <div style="border-top: 1px solid rgba(0,0,0,0.08); padding-top: 24px; margin-top: 20px;">
